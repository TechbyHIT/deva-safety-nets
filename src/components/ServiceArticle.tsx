...
const TRUST_STATS = [
  { icon: ShieldCheck, value: "Certified", label: "Materials" },
  { icon: Clock, value: "1–2 days", label: "Typical install" },
  { icon: Award, value: "Up to 10-yr", label: "Warranty" },
  { icon: BadgeCheck, value: "Free", label: "Site survey" },
];
